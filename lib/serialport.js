...
var defaultSettings = {
  ...
  // platformOptions: Binding.platformOptions
};
 ...
 * @property {module:serialport~Binding=} Binding The hardware access binding, The Binding is how node SerialPort talks to the underlying system. By default we auto detect windows, Linux and OSX and load the appropriate module for your system.
...
SerialPort.prototype.open = function(callback) {
  ...
  this.opening = true;
  this.binding.open(this.path, this.options, function(err) {
    this.opening = false;
    if (err) {
...
SerialPort.prototype.update = function(options, callback) {
  ...
  this.binding.update(this.options, function(err) {
    if (err) {
      return this._error(err, callback);
    }
    if (callback) { callback.call(this, null) }
